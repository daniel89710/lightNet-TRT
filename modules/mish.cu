...
void MishPlugin::configureWithFormat(
...
bool MishPlugin::isOutputBroadcastAcrossBatch(
...
// Attach the plugin object to an execution context and grant the plugin the access to some context
// resource.
void MishPlugin::attachToContext(
...
IPluginV2 * MishPluginCreator::deserializePlugin(
